export default {
  feedback: {
    answer: {
      ...
      dislike: '没有帮助',
      removeDislike: '取消点踩',
      dislikeTitle: '这个回答哪里需要改进？',
      dislikePrompt: '请选择主要原因，帮助我们改进知识内容。',
      otherPlaceholder: '补充说明（选填）',
    ...
    governance: {
      navLabel: '反馈质量',
      title: '反馈质量',
      description: '查看归因到知识片段的回答反馈，并治理片段召回权重。',
      searchPlaceholder: '搜索片段内容或文档标题',
      untitledKnowledge: '未命名文档',
      needsOptimization: '需要优化',
      healthy: '状态正常',
      viewDetail: '查看反馈详情',
      loadFailed: '片段反馈加载失败。',
      detailFailed: '反馈详情加载失败。',
      detailTitle: '片段反馈详情',
      likes: '点赞',
      dislikes: '点踩',
      positiveRate: '好评率',
      ...
      reset: '重置反馈',
      resetTitle: '确认重置片段反馈？',
      resetDescription: '聚合数据和召回权重将恢复默认值，原始反馈与历史日志会继续保留。',
      resetReasonPlaceholder: '填写重置原因（选填）',
      confirmReset: '确认重置',
