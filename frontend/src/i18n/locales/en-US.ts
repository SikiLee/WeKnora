export default {
  feedback: {
    answer: {
      ...
      dislikeTitle: 'What could be improved?',
      dislikePrompt: 'Choose the main reason so the knowledge can be improved.',
    ...
    governance: {
      navLabel: 'Feedback quality',
      title: 'Feedback quality',
      description: 'Review answer feedback attributed to each knowledge chunk and manage its recall weight.',
      searchPlaceholder: 'Search chunk content or document title',
      untitledKnowledge: 'Untitled document',
      needsOptimization: 'Needs review',
      healthy: 'Healthy',
      viewDetail: 'View feedback detail',
      loadFailed: 'Could not load chunk feedback.',
      detailFailed: 'Could not load feedback detail.',
      detailTitle: 'Chunk feedback detail',
      likes: 'Likes',
      dislikes: 'Dislikes',
      ...
      noReasons: 'No dislike reasons recorded',
      weightHistory: 'Weight history',
      reset: 'Reset feedback',
      resetTitle: 'Reset chunk feedback?',
      resetDescription: 'Aggregates and recall weight will return to their defaults. Raw feedback and history are retained.',
      resetReasonPlaceholder: 'Reason for reset (optional)',
      confirmReset: 'Reset',
      ...
      optimization: {
        all: 'All optimization states',
        yes: 'Needs review',
        no: 'No review needed',
      },
      sort: {
        feedback_updated_at: 'Latest feedback',
        like_count: 'Most likes',
        dislike_count: 'Most dislikes',
        positive_rate: 'Positive rate',
        recall_weight: 'Recall weight',
