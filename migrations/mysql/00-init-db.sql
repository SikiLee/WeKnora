...
CREATE TABLE chunks (
    ...
    feedback_updated_at TIMESTAMP(6) NULL DEFAULT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE message_feedbacks (
    ...
    KEY idx_message_feedbacks_session (session_tenant_id, session_id, message_id),
...
CREATE TABLE message_chunk_references (
    ...
    KEY idx_message_chunk_refs_session (session_tenant_id, session_id, message_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
